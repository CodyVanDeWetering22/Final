    ...
    <div class="modal fade" id="createKeepModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div @submit.prevent="createKeep" class="modal-body">
                    <form>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input required v-model="editable.img" type="url" class="form-control" id="name">
                        </div>

                        <div class="col-10">
                            <label for="description" class="form-label">Keep Description</label>
                            <textarea required v-model="editable.description" type="text" id="description"
                                class="form-control"> </textarea>
                        </div>

                        <div class="col-10 text-end">
                            <div class="modal-footer">
                                <button type="s" class="btn btn-warning">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
